---
title: "MATH 201: Lecture 9b Handout"
subtitle: "7.1 Inference for a mean (Part 1)"
format: 
  pdf:
    echo: false
    message: false
...
| Population parameter (unknown) | Sample statistic (point estimate) | Sampling distribution | Mean | Standard error |
|:--------------------|:--------------------|:-----------------|:------------|:-----------------------------|
